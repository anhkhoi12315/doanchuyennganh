...
const { updateProfile, getProfile, requestChangeEmailOtp, verifyCurrentEmailOtp, requestNewEmailOtp, changeEmail, requestChangePasswordOtp, changePassword } = require("../controllers/profileController");
 ...
 * /profile/update:
 *   put:
 *     summary: Cập nhật thông tin cá nhân (không cho đổi `email` hoặc `password`)
 *     tags: [Profile]
 *     security:
 *       - bearerAuth: []
 *     requestBody:
